...
/**
 * mockData를 불러오는 함수(1.5초 딜레이)
 * @param pageNum 페이지 인덱스
 * @returns 페이지 인덱스에 해당하는 데이터(mockData[])와 페이지의 끝 여부(boolean)
 */
export const getMockData: MockDataResponse = (pageNum: number) => {
